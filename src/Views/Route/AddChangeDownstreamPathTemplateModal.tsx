...
const AddChangeDownstreamPathTemplateModal = (props: IProps) => {
  ...
  useEffect(() => {
    if (props.changeDownstreamPathTemplateAdd.Visible)
      resetForm([
        {
          fileConfigurationId:
            props.changeDownstreamPathTemplateAdd.fileConfigurationId,
        },
        { fileRouteId: props.changeDownstreamPathTemplateAdd.fileRouteId },
      ]);
  }, [props.changeDownstreamPathTemplateAdd.Visible]);
  const formSubmitHandler = () => {
    if (onFormSubmit()) {
      props.addChangeDownstreamPathTemplate(values, props.routeId);
    } else
      props.pushAlert({
        title: t("userError"),
    ...
    return (
      <React.Fragment>
        <button
          ...
          onClick={() =>
            props.toggleAddChangeDownstreamPathTemplateModal(0, 0, false)
          }
        >
          {t("cancel")}
        </button>
  ...
  return (
    <GymModal
      ModalTitle={t("addChangeDownstreamPathTemplate")}
      Visible={props.changeDownstreamPathTemplateAdd.Visible}
      onCancel={() =>
        props.toggleAddChangeDownstreamPathTemplateModal(0, 0, false)
      }
      buttons={<Buttons />}
...
export default connect(
  ...
  routeActions
)(AddChangeDownstreamPathTemplateModal);
